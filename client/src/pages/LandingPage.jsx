    ...
    <div className="landingPage">
        <div className="landingHero">
          ...
          <div className="landingHero-title">
            <h1 className="banner-h1">Welcome to Lunar Air! ✈️</h1>
            <p className="banner-p">Your journey starts here! At Lunar Air, we make booking flights smooth and hassle-free. Whether you're traveling for work, vacation, or a spontaneous getaway, our app is designed to bring you the best deals, flexible options, and a seamless booking experience.</p>     
          </div>
        ...
        <div className="container">
            ...
            <p className="section-description">
                &nbsp; &nbsp;&nbsp; &nbsp; At Lunar Air, we believe that travel should be simple, affordable, and accessible to everyone. Founded with a passion for exploration, our mission is to bring the world within reach by providing a seamless, intuitive flight booking experience for travelers everywhere.
            </p>
            <p className="section-description">
                &nbsp; &nbsp;&nbsp; &nbsp; We are committed to transparency, unbeatable fares, and top-notch customer service. With Lunar Air, you can expect easy-to-navigate options, flexible booking features, and exclusive deals to make each trip planning experience stress-free and affordable.
            </p>
            <p className="section-description">
                &nbsp; &nbsp;&nbsp; &nbsp; Whether you’re arranging a business trip or planning a dream vacation, Lunar Air is your trusted partner. Let us handle the details so you can focus on your next adventure, exploring the world with confidence and excitement!
            </p>

            <span><h5>2024 Lunar Air - &copy; All rights reserved</h5></span>
